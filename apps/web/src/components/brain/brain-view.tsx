...
/**
 * The Brain page (BRAIN.md §5/§6 — Orion lane).
 *
 ...
 * that legitimately may not exist yet (the Graphify sidecar is Atlas's lane and
 * the REST routes are Nova's), so "not built yet" is a first-class, calm state
