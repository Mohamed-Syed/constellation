...
export type ScheduledTaskRecord = {
  ...
  /** Workflow triggers round: when set, firing this runs the workflow, not a task. */
  workflowId: string | null;
  /** Team spaces follow-up (BG3): team scope (null = global/personal). */
  teamId: string | null;
  /** Actor id of the creator (ownership). */
...
export class ScheduledTaskService {
  ...
  async create(dto: CreateScheduleDto, actorId: string | null = null): Promise<ScheduledTaskRecord> {
