#!/usr/bin/env bash
# Phase 4.0 — MCP SERVER live proof. ONE invocation:
#  1) boot api EMBEDDED;
...
# 1. initialize
MCP '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2025-03-26","capabilities":{},"clientInfo":{"name":"constellation-proof","version":"1.0"}}}' > "$OUT/01-initialize.json"
