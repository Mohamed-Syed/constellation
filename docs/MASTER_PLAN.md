...
3. **Prometheus metrics + health dashboard** — `/api/metrics` DONE (`ac2cf11`), **portal `/health` page DONE (`0647666`, LIVE-PROVEN in a browser)**; remaining: pre-built Grafana dashboard JSON.
