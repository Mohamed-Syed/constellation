...
└── docs/                    # this documentation + the development journal
```
...
This is proven live in [`artifacts/`](../artifacts/) (kill the API at step N, query Postgres to
...
> §6). See [SUPER_SESSION_SUMMARY.md](SUPER_SESSION_SUMMARY.md) for that independent review.
