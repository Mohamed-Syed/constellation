...
- ⏳ **Remaining:** 2.6 real SSO round-trip (P1 — Keycloak+Caddy are booted in the federation overlay; the OIDC seam + a real login round-trip are unproven end-to-end), 2.7 plugin sandboxing (P1), 2.8 worker as separate process (P2).
